...
Cls()  --清屏
TalkEx("任教主、向大哥，你们怎么*样？", 0, 1)  --对话
Cls()  --清屏
TalkEx("还好，死不了。这东方不败*已经练成葵花宝典上的武功*，你们可千万小心。", 26, 0)  --对话
Cls()  --清屏
TalkEx("任教主，这部《葵花宝典》*是你传给我的．我一直念着*你的好处．", 27, 0)  --对话
Cls()  --清屏
TalkEx("是吗？*因此你将我关在西湖湖底，*教我不见天日．", 26, 0)  --对话
Cls()  --清屏
TalkEx("我没杀你，是不是？***只须我叫江南四友不送水给*你喝，你能捱的了十天半月*吗？", 27, 0)  --对话
Cls()  --清屏
TalkEx("这样说来，你待我还算不错*了？", 26, 0)  --对话
Cls()  --清屏
TalkEx("正是．我让你在杭州西湖颐*养天年．*常言道，上有天堂，下有苏*杭．西湖风景，那是天下有*名的了，孤山梅庄，更是西*湖景色绝佳之处．", 27, 0)  --对话
Cls()  --清屏
TalkEx("原来你让我在西湖湖底的黑*牢中颐养天年．*那可要多谢你了．", 26, 0)  --对话
Cls()  --清屏
TalkEx("任教主，你待我的种种好处*我永远记得．*你破格提拔，连年升我职，*甚至连本教至宝的”葵花宝*典”也传给了我．此恩此德*东方不败永不敢忘．*初时我一心只想做日月神教*教主，想什麽千秋万载，一*统江湖，於是处心积虑的谋*你的位，翦除你的羽翼．*我初当教主，那可意气风发*了，说什麽文成武德，中兴*圣教，当真是不要脸的胡吹*法螺．**直到後来修习”葵花宝典”*才慢慢悟到了人生妙谛．**其後勤修内功，数年之後，*终於明白了天人化生，万物*滋长的要道．*如今，我最羡慕的就是那些*青春年少的娇媚女子，如果*能易地而处，别说日月神教*的教主，就算是皇帝老子，*我也不做．", 27, 0)  --对话
Cls()  --清屏
...
Cls()  --清屏
TalkEx(" 胡说八道！什麽千秋万载*？哈！哈！哈！《葵花宝典*》啊《葵花宝典》，你终于*又回到我手里了，可惜，这*并不是常人可以练的．", 26, 0)  --对话
Cls()  --清屏
TalkEx("这话怎讲？", 0, 1)  --对话
Cls()  --清屏
TalkEx("这宝典的第一页就注明着，*”欲练神功，引刀自宫”，*老夫可不会没了脑子，去干*这等傻事．*哈哈，哈哈．．．．**可是宝典上所载的武功实在*厉害，任何学武之人，一见*之後却不能不动心．*东方不败，饶你奸诈似鬼，*也猜不透老夫传你”葵花宝*典”的用意．*你野心勃勃，意存拔扈，*难道老夫瞧不出来吗？*哈哈，哈哈！", 26, 0)  --对话
Cls()  --清屏
TalkEx("＜原来当初任教主以”葵花*  宝典”传他，当初便没怀*  善意．＞*＜两人尔虞我诈各怀心机＞", 0, 1)  --对话
Cls()  --清屏
TalkEx("任我行将那《葵花宝典》放*在双掌中一搓，功力到处，*原已十分陈旧的册页登时化*为碎片。", 0, 2)  --对话
Cls()  --清屏
TalkEx("这种害人东西，毁了最好。", 0, 1)  --对话
Cls()  --清屏
TalkEx("小兄弟，这一役诛奸复位，*你实占首功．不如加入我日*月神教，我可以给你个副教*主做做，待我百年之后，这*教主的位置就是你的，如何*？", 26, 0)  --对话
Cls()  --清屏
TalkEx("＜区区一个教主，我很希罕*吗？＞任教主的好意，在下*心领了。我还要去寻找十四*天书，恕不能从命。告辞了*。", 0, 1)  --对话
Cls()  --清屏
