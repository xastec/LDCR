...
if r==1 then
   ...
   instruct_0(); 
   TalkEx("少侠，那都是很好很好的，可是我偏不喜欢。",242,0);  
   instruct_0();   
   if GetS(4, 5, 5, 5)==7 and instruct_43(8)==true then
      TalkEx("<对了，我记得少侠包袱里面有救命的药>少侠快快服下。",242,0);  
      instruct_0();
      instruct_14();
      instruct_13();
      TalkEx("你是谁？我在哪里？",0,1);  
      ...
      if WarMain(20) then    --主角挑战心魔
         ...
         instruct_0();
         TalkEx("少侠，你终于醒了，吓死我了。",242,0);  
         instruct_0();  
         TalkEx("我没事了，阿秀。",0,1);  
         instruct_0();
         TalkEx("少侠，你若走了，我便...",242,0);  
         instruct_0(); 
         TalkEx("阿秀，不可以乱说话。",0,1);  
         instruct_0();
         TalkEx("少侠，我想...陪你一起去江南看看柳条，看一辈子。",242,0);  
         instruct_0(); 
         TalkEx("阿秀...<陪你一辈子...>",0,1);  
         instruct_0();
   ...
   instruct_37(-5);       --道德-5
   instruct_0();
   TalkEx("少侠，我知道你担负着重要的使命。我的命是你救回来的，阿秀正当替少侠分忧。反正师父和计爷爷都走了，苏普也有他的阿曼，阿秀了无心愿了。只是希望少侠能采一支江南的柳条放在阿秀的坟前。",242,0);  
   instruct_0();  
   TalkEx("阿秀，不可！",0,1);  
   instruct_0();
   TalkEx("少侠，阿秀去了。<如果有来世，我真的希望自己不是被真主惩罚的汉人，再见了，天铃鸟，再见了，少侠，再见了，苏普...>",242,0);  
   instruct_0();   
   if GetS(4, 5, 5, 5)==7 and instruct_43(8)==true then
