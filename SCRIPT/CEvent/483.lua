...
Cls()  --清屏
TalkEx("郭大哥，黄姑娘，原来你们*在这里啊", 247, 1)  --对话
Cls()  --清屏
TalkEx("小兄弟，快来拜见，这位就*是南帝一灯大师。", 55, 0)  --对话
Cls()  --清屏
TalkEx("晚辈参见一灯大师。", 0, 1)  --对话
Cls()  --清屏
TalkEx("阿弥陀佛，少侠不必多礼。", 65, 0)  --对话
Cls()  --清屏
TalkEx("对了郭大哥，黄姑娘的伤怎*么样了？", 0, 1)  --对话
Cls()  --清屏
TalkEx("多亏了一灯大师舍身相救，*现在蓉儿已经无碍了，只是*大师他……", 55, 0)  --对话
Cls()  --清屏
...
Cls()  --清屏
TalkEx("段皇爷，别怪兄弟我下手狠*了……", 60, 0)  --对话
Cls()  --清屏
TalkEx("是裘千仞和欧阳锋！你们保*护好一灯大师，我来对付他*们！", 245, 1)  --对话
Cls()  --清屏
instruct_37(5)  --增加品德
...
Cls()  --清屏
instruct_13()  --场景变亮
TalkEx("今日他们人多，取不得段皇*爷的性命，不过他已武功全*失，无法参加华山论剑，哈*哈，我们走吧！", 60, 0)  --对话
Cls()  --清屏
...
Cls()  --清屏
TalkEx("怎么能说很好呢？你可是已*经武功全失了啊！", 244, 1)  --对话
Cls()  --清屏
TalkEx("不错。我玄功有损，原须修*习五年，方得复元。但这位*郭贤侄熟记九阴真经，其中*有一段用梵文书写，老衲恰*巧懂得梵文，将其译出，乃*是疗伤圣法。依这真经练去*，看来不用三月，便能有五*年之功。", 65, 0)  --对话
Cls()  --清屏
TalkEx("真是太好了，这九阴真经不*愧是武学宝典啊。", 247, 1)  --对话
Cls()  --清屏
TalkEx("我听靖儿和蓉儿说，七公深*受重伤。如果依真经练法，*也能尽快复原。少侠，麻烦*你把这疗伤之法告诉七公。", 65, 0)  --对话
Cls()  --清屏
TalkEx("晚辈遵命。", 0, 1)  --对话
Cls()  --清屏
TalkEx("蓉儿重伤初愈，需要休息，*我们先回桃花岛，兄弟如果*需要，就去桃花岛找我们。", 55, 0)  --对话
Cls()  --清屏
instruct_14()  --场景变黑
