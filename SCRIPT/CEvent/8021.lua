...
if GetS(53, 0, 2, 5) == 1 and GetS(53, 0, 3, 5) == 1 and GetBookNum() >= 10 then
  ...
  if r >=1 and r <=5 then
	...
	JY.Person[JY.MY]["攻击力"] = JY.Person[JY.MY]["攻击力"] + 30
  JY.Person[JY.MY]["防御力"] = JY.Person[JY.MY]["防御力"] + 30
  JY.Person[JY.MY]["轻功"] = JY.Person[JY.MY]["轻功"] + 30
  
  DrawStrBoxWaitKey(string.format("%s攻防轻能力各提升30点",JY.Person[JY.MY]["姓名"]), C_ORANGE, CC.DefaultFont)
  ShowScreen()
