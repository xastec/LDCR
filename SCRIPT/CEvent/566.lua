...
Cls()  --清屏
TalkEx("薛神医，请您一定要治好这*位姑娘。", 50, 0)  --对话
Cls()  --清屏
TalkEx("哼！", 45, 0)  --对话
Cls()  --清屏
TalkEx("乔大哥……", 104, 0)  --对话
Cls()  --清屏
TalkEx("各位既已和乔某喝过了这绝*交酒，咱们从前的交情就一*笔勾销。哪一个先来决一死*战！", 50, 0)  --对话
Cls()  --清屏
instruct_30(43,30,29,30)  --人物移动
instruct_30(29,30,29,28)  --人物移动
TalkEx("尊驾何人？要取乔某性命，*尽管来吧！", 50, 0)  --对话
Cls()  --清屏
TalkEx("乔兄误会了。我深信乔兄为*人，大丈夫光明磊落，那些*杀人放火的勾当，绝非乔兄*所为。我今日来此，誓要与*乔兄并肩作战！", 0, 1)  --对话
Cls()  --清屏
TalkEx("哈哈哈……今日，相交多年*的好友都跟乔某喝了这绝交*酒，没想到一位素昧平生的*小兄弟却愿与我共患难。好*兄弟，就让你我二人联手抗*敌，看看他们都有些什么本*领！", 50, 0)  --对话
Cls()  --清屏
...
Cls()  --清屏
instruct_13()  --场景变亮
TalkEx("＜今日众人是都冲着我来的*，怎能让这个小兄弟跟着我*无辜受牵连……＞，小兄弟*，多谢你了，接招！", 50, 0)  --对话
Cls()  --清屏
...
TalkEx("啊……我这是在哪里啊？啊*……想起来了……乔帮主…*…乔帮主用他最后的内力把*我送出了聚贤庄，那他呢？", 244, 1)  --对话
Cls()  --清屏
do return end
