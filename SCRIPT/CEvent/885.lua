...
TalkEx("令狐少侠光临敝寺是否是为*了任小姐的事情？", 70, 0)  --对话
Cls()  --清屏
TalkEx("正是，希望大师高抬贵手，*放盈盈下山吧。", 35, 1)  --对话
Cls()  --清屏
TalkEx("你这畜生，竟然为了魔教教*主之女而前来少林滋事！", 19, 0)  --对话
Cls()  --清屏
instruct_14()  --场景变黑
...
Cls()  --清屏
instruct_13()  --场景变亮
TalkEx("任先生复出，江湖上从此多*事，只怕将有无数人命伤在*任先生手下。老衲有意屈留*任小姐等任先生来救女儿，*老纳也好趁机劝说任先生改*恶向善，屈留他在敝寺盘桓*，诵经礼佛，教江湖上得以*太平。", 70, 0)  --对话
Cls()  --清屏
TalkEx("＜原来他们早已经聚集了高*手，就等把任我行引来了。*＞", 0, 1)  --对话
Cls()  --清屏
TalkEx("玄慈大师，您心地过于善良*，令狐冲是任老怪的乘龙快*婿，既然您已经告诉他真相*了，咱们也不能放他们下山*，免得他们向任老怪通风报*信。", 22, 0)  --对话
Cls()  --清屏
...
Cls()  --清屏
instruct_13()  --场景变亮
TalkEx("善哉善哉，看来天意如此，*老纳好久不在江湖走动，现*在真是后生可畏呀。你们把*任小姐带下山去，请几位失*主下山后请转告任先生以天*下沧生的性命为重，少开杀*戒。阿弥陀佛。", 70, 0)  --对话
Cls()  --清屏
TalkEx("冲哥，我就知道您能来救我*。方丈大师，您慈悲为怀，*小女子永世不忘。", 73, 1)  --对话
Cls()  --清屏
