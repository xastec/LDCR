...
Cls()  --清屏
TalkEx("原来是你这小子，找我有什*么事？", 29, 0)  --对话
Cls()  --清屏
if instruct_9() == false then  --是否要求加入
	TalkEx("没什么事。路过此地，随便*看看。", 0, 1)  --对话
	Cls()  --清屏
...
if instruct_28(0,40,999) == false then  --判断品德是否在范围之内
	...
	TalkEx("你小子虽然是个孬种，但总*还不是道貌岸然的伪君子，*况且你的队伍里还有漂亮小*妞，我就跟着你吧。", 29, 0)  --对话
	Cls()  --清屏
	instruct_37(-5)  --增加品德
...
TalkEx("我最恨的就是道貌岸然的伪*君子！", 29, 0)  --对话
Cls()  --清屏
do return end
