...
TalkEx("呵呵呵……", 87, 0)  --对话
Cls()  --清屏
TalkEx("喂，你瞧，瞧……", 225, 1)  --对话
Cls()  --清屏
TalkEx("什么啊？", 0, 1)  --对话
Cls()  --清屏
TalkEx("大美女啊……", 225, 1)  --对话
Cls()  --清屏
TalkEx("这个，小宝兄，那可是人家*的老婆啊。", 246, 1)  --对话
Cls()  --清屏
TalkEx("想想办法，搞过来啊。", 225, 0)  --对话
Cls()  --清屏
TalkEx("什么人，胆敢擅闯神龙教！", 71, 0)  --对话
Cls()  --清屏
TalkEx("啊？啊，我，就是来找找有*没有我要的书。", 247, 1)  --对话
Cls()  --清屏
...
Cls()  --清屏
TalkEx("？？？你好像心里有鬼啊？", 246, 1)  --对话
Cls()  --清屏
TalkEx("我有什么鬼？没有就是没有*，你要是再不滚蛋，就休怪*我不客气了！", 71, 0)  --对话
Cls()  --清屏
TalkEx("哼，打就打，谁怕谁。", 0, 1)  --对话
Cls()  --清屏
TalkEx("啊，这就开打啦，你们先上*，我掩护。", 225, 1)  --对话
Cls()  --清屏
TalkEx("等一下，等一下，我还有件*重要的事……", 225, 1)  --对话
Cls()  --清屏
TalkEx("？？？", 0, 1)  --对话
Cls()  --清屏
TalkEx("千万要注意，别伤到美女。*好，你们继续！", 225, 1)  --对话
Cls()  --清屏
...
if instruct_43(228) then  --判断是否有物品
	...
	TalkEx("这位美女，啊不，教主夫人*，仙福永享，寿与天齐，那*个，你若没什么事，跟我们*一起走吧。", 225, 1)  --对话
	Cls()  --清屏
	TalkEx("你说什么！休打我夫人的主*意。", 71, 0)  --对话
	Cls()  --清屏
	TalkEx("我原本以为呢，你就是武功*天下第一了，没想到随便来*几个人，就把你打得落花流*水，唉……", 87, 0)  --对话
	Cls()  --清屏
	TalkEx("我，我……", 71, 0)  --对话
	Cls()  --清屏
	TalkEx("你什么你，你都七老八十了*，还霸占着这么漂亮的美眉*，你够了你。夫人，咱们走*吧。", 225, 1)  --对话
	Cls()  --清屏
	...
	Cls()  --清屏
	TalkEx("人都走了，还傻看什么，小*宝，咱们也走吧，这没有要*找的书了。", 0, 1)  --对话
	Cls()  --清屏
...
Cls()  --清屏
TalkEx("这是什么书？看你的样子一*定有问题，我先替你保管着*吧。", 0, 1)  --对话
Cls()  --清屏
TalkEx("这位美女，啊不，教主夫人*，仙福永享，寿与天齐，那*个，你若没什么事，跟我们*一起走吧。", 225, 1)  --对话
Cls()  --清屏
TalkEx("你说什么！休打我夫人的主*意。", 71, 0)  --对话
