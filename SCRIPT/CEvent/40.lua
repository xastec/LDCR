...
if instruct_9() then  --是否要求加入
	TalkEx("看你也无家可归，和我一起*走吧，路上也有个照应。", 0, 1)  --对话
	Cls()  --清屏
	if instruct_28(0,70,100) then --判断品德是否在范围之内
		instruct_37(2)  --增加品德
		TalkEx("好吧！如果你不怕被我这个*不幸之人连累的话。", 37, 0)  --对话
		Cls()  --清屏
		...
		TalkEx("你的队伍已满，我就直接去*小村吧。", 37, 0)  --对话
		Cls()  --清屏
	...
	TalkEx("不了！我这个不幸之人还是*别害人的好。", 37, 0)  --对话
	Cls()  --清屏

end
if instruct_5() then  --是否与之过招
	instruct_37(-2)  --增加品德
	TalkEx("你说那个什么神照经，拿出*来看看啊", 0, 1)  --对话
	Cls()  --清屏
	TalkEx("不行，这是丁大哥的遗物，*不能随便交给他人。", 37, 0)  --对话
	Cls()  --清屏
	TalkEx("哼，小子，不给我，我不会*硬抢吗？凡是书，我都不会*放过！", 245, 1)  --对话
	Cls()  --清屏
