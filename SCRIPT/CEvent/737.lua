...
TalkEx("南贤北丑这两个老不死的，*不就是管他们借了50两银子*吗，就来给我摊派任务。*唉，人穷志短啊，谁让我没*钱呢？*这就是我的柴刀十八路，*你拿去学吧。", 241, 0)  --对话
Cls()  --清屏
instruct_2(166, 1)  --得到或失去物品
Cls()  --清屏
TalkEx("多谢黎前辈", 247, 1)  --对话
Cls()  --清屏
TalkEx("我这可没有什么弟子帮你练*功，自己出去练吧！", 241, 0)  --对话
Cls()  --清屏
instruct_3(-2, -2,0,0,738,0,0,-2,-2,-2,-2,-2,-2)  --修改场景事件
...
instruct_3(70, 3,1,0,692,0,0,-2,-2,-2,-2,-2,-2)  --修改场景事件
