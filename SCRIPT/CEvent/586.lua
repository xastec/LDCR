TalkEx("慕容公子，别来无恙？", 247, 1)  --对话
Cls()  --清屏
TalkEx("少侠今日来燕子坞，不知有*何指教？", 51, 0)  --对话
Cls()  --清屏
...
TalkEx("不敢不敢，在下最近旅途颇*有不顺，想请慕容公子帮忙*。", 0, 1)  --对话
Cls()  --清屏
TalkEx("＜这小子很有利用价值，帮*帮他不会有坏处＞，哈哈，*好说好说", 51, 0)  --对话
Cls()  --清屏
instruct_37(-1)  --增加品德
...
TalkEx("你的队伍已满，我就直接去*小村吧。", 51, 0)  --对话
Cls()  --清屏
