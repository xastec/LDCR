...
TalkEx("哦，既是南贤推荐来的，我*就把我们青城派的绝学松风*剑法传授给你吧。", 24, 0)  --对话
Cls()  --清屏
instruct_2(134, 1)  --得到或失去物品
Cls()  --清屏
TalkEx("多谢余观主。", 0, 1)  --对话
Cls()  --清屏
TalkEx("有不懂的地方，可以和练功*房里的青城弟子共同研究。", 24, 0)  --对话
Cls()  --清屏
instruct_3(36, 4,0,0,730,0,0,-2,-2,-2,-2,-2,-2)  --修改场景事件
