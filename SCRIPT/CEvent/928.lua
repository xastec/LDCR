...
Cls()  --清屏
TalkEx("又是一年秋风送爽，又是一*日天高云淡。", 255, 0)  --对话
Cls()  --清屏
TalkEx("我们怀着无比激动的心情，*迎来了第29届奥林匹克大会*。", 256, 0)  --对话
Cls()  --清屏
TalkEx("本次大会的主题是——同一*个武林，同一个梦想！", 255, 0)  --对话
Cls()  --清屏
TalkEx("首先进行的是个人赛，下面*请一号选手上场！", 256, 0)  --对话
Cls()  --清屏
...
TalkEx("比赛规则是，一号选手为擂*主。任何人都可以向擂主挑*战，战胜擂主的人将成为新*的擂主，直到无人挑战为止*。每个人上台前请先通名报*姓。", 256, 0)  --对话
Cls()  --清屏
TalkEx("这就是你的公平规则啊！！*为什么我是一号？", 246, 1)  --对话
Cls()  --清屏
...
Cls()  --清屏
instruct_13()  --场景变亮
TalkEx("让你尝尝我恶贯满盈段延庆*的厉害", 98, 0)  --对话
Cls()  --清屏
...
Cls()  --清屏
instruct_13()  --场景变亮
TalkEx("年轻人，你已连赛三场，可*以稍微休息一下。", 255, 0)  --对话
Cls()  --清屏
instruct_12()  --休息
TalkEx("我丁不三今日还没杀够三个*人，算你一个吧。", 162, 0)  --对话
Cls()  --清屏
...
Cls()  --清屏
instruct_13()  --场景变亮
TalkEx("阿弥陀佛，少林方丈玄慈来*领教阁下高招。", 70, 0)  --对话
Cls()  --清屏
...
Cls()  --清屏
instruct_13()  --场景变亮
TalkEx("我乃桃花岛主，人称东邪黄*药师的便是", 57, 0)  --对话
Cls()  --清屏
...
Cls()  --清屏
instruct_13()  --场景变亮
TalkEx("我是欧阳锋，我就是西毒欧*阳锋。", 60, 0)  --对话
Cls()  --清屏
...
Cls()  --清屏
TalkEx("好，个人赛结束，下面进行*的是团体赛。", 255, 0)  --对话
Cls()  --清屏
TalkEx("团体战的规则是：有仇报仇*，有冤报冤，一场定输赢，*人数无限制！", 256, 0)  --对话
Cls()  --清屏
TalkEx("你这是什么规则啊！", 246, 1)  --对话
Cls()  --清屏
if instruct_28(0,50,999) == false then  --判断品德是否在范围之内
	TalkEx("小子，你看看你都干了些什*么！武林正道绝不容你！", 69, 0)  --对话
	Cls()  --清屏
...
if instruct_28(0,50,999) then --判断品德是否在范围之内
	TalkEx("哈哈，小子，我们单打不是*你的对手，一群人来怎么样*？", 60, 0)  --对话
	Cls()  --清屏
...
Cls()  --清屏
TalkEx("好，团体赛结束。现在我宣*布，本次大会的冠军是——**这小子！", 256, 0)  --对话
Cls()  --清屏
TalkEx("……怎么从头到尾都没人叫*我的名字啊……", 0, 1)  --对话
Cls()  --清屏
