...
Cls()  --清屏
TalkEx("少侠，可否再借老夫一看？", 32, 0)  --对话
Cls()  --清屏
TalkEx("秃老头，要看可以，*先打赢我再说．", 0, 1)  --对话
Cls()  --清屏
TalkEx("说什麽？*我最痛恨人家叫我秃子，*你这小子太不知死活了．", 32, 0)  --对话
Cls()  --清屏
TalkEx("秃头秃头，下雨不愁，*人家有伞，我有秃头．", 247, 1)  --对话
Cls()  --清屏
TalkEx("好小子，*我瞧你是活得不耐烦了，*看看老夫怎麽收拾你．", 32, 0)  --对话
Cls()  --清屏
...
Cls()  --清屏
TalkEx("小伙子，果然有两下子，*可是那“率意帖”我是要定*了．", 32, 0)  --对话
Cls()  --清屏
TalkEx("三庄主，别自不量力了．*我看这梅庄之中也没什麽能*手了，真是害我白走一趟．", 0, 1)  --对话
Cls()  --清屏
TalkEx("四弟，咱们去求二哥帮忙．", 33, 0)  --对话
Cls()  --清屏
instruct_14()  --场景变黑
