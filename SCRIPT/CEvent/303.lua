...
Cls()  --清屏
TalkEx("范右使临行之前，将倚天屠*龙记一书交与老衲，如今成*昆终于伏法，此书就送与少*侠吧。", 70, 0)  --对话
Cls()  --清屏
instruct_2(155, 1)  --得到或失去物品
Cls()  --清屏
TalkEx("望少侠今后少生杀戮，多行*善事，阿弥陀佛，善哉善哉*。", 70, 0)  --对话
Cls()  --清屏
TalkEx("谢逊法王临行之前，将屠龙*宝刀交与老衲，并交待如少*侠将成昆伏法，则将此宝刀*赠与少侠。", 70, 0)  --对话
